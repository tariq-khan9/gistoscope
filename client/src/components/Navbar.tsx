...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="navbar font-quicksand font-semibold px-4 sm:px-6 md:px-12  bg-blue-900 text-white sm:h-14 flex flex-row items-center justify-between space-x-2 sm:space-x-4">
